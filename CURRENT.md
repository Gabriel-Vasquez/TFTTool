...
- Phase: TFTTool 0.6.3 production-BETA correction is package-validated; controlled-channel publication is in progress.
- Branch: `main`.
...
1. Complete full/package/visual QA for 0.6.3, publish its installer release, then atomically advance `updates/stable.json` so existing 0.6.2 installations receive it through Settings > Update TFTTool.
